...
class SetLed_Request(metaclass=Metaclass_SetLed_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.ledno = kwargs.get('ledno', int())
    ...
    @ledno.setter
    def ledno(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'ledno' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'ledno' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._ledno = value
...
class Metaclass_SetLed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from msg_interface.srv import _set_led
...
class SetLed(metaclass=Metaclass_SetLed):
    from msg_interface.srv._set_led import SetLed_Request as Request
    from msg_interface.srv._set_led import SetLed_Response as Response
