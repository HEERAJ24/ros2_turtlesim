...
static const _HardwareStatus_type_support_symbol_names_t _HardwareStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interface, msg, HardwareStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_interface, msg, HardwareStatus)),
  }
};
...
{
  return &::msg_interface::msg::rosidl_typesupport_cpp::HardwareStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_interface, msg, HardwareStatus)() {
  return get_message_type_support_handle<msg_interface::msg::HardwareStatus>();
}
