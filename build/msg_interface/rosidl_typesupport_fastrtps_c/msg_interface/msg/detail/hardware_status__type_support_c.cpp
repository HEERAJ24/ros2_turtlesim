...
#include "msg_interface/msg/detail/hardware_status__rosidl_typesupport_fastrtps_c.h"
...
using _HardwareStatus__ros_msg_type = msg_interface__msg__HardwareStatus;
...
size_t get_serialized_size_msg_interface__msg__HardwareStatus(
  const void * untyped_ros_message,
...
static uint32_t _HardwareStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_interface__msg__HardwareStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msg_interface
size_t max_serialized_size_msg_interface__msg__HardwareStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_interface__msg__HardwareStatus;
    is_plain =
      (
...
static size_t _HardwareStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_interface__msg__HardwareStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_interface, msg, HardwareStatus)() {
