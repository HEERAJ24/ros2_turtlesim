...
#include "msg_interface/srv/detail/set_led__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_interface::srv::SetLed_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_interface::srv::SetLed_Request & ros_message)
{
  // Member: ledno
  cdr >> ros_message.ledno;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_interface::srv::SetLed_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_interface::srv::SetLed_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_interface::srv::SetLed_Request *>(
    untyped_ros_message);
...
{
  return &msg_interface::srv::typesupport_fastrtps_cpp::_SetLed_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interface, srv, SetLed_Request)() {
  return &msg_interface::srv::typesupport_fastrtps_cpp::_SetLed_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_msg_interface
cdr_serialize(
  const msg_interface::srv::SetLed_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_interface::srv::SetLed_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = msg_interface::srv::SetLed_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_interface::srv::SetLed_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<msg_interface::srv::SetLed_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &msg_interface::srv::typesupport_fastrtps_cpp::_SetLed_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interface, srv, SetLed_Response)() {
  return &msg_interface::srv::typesupport_fastrtps_cpp::_SetLed_Response__handle;
}
...
{
  return &msg_interface::srv::typesupport_fastrtps_cpp::_SetLed__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interface, srv, SetLed)() {
  return &msg_interface::srv::typesupport_fastrtps_cpp::_SetLed__handle;
}
