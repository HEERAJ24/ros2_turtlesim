...
#ifndef MSG_INTERFACE__SRV__DETAIL__SET_LED__FUNCTIONS_H_
#define MSG_INTERFACE__SRV__DETAIL__SET_LED__FUNCTIONS_H_
 ...
 * calls
 * msg_interface__srv__SetLed_Request__init().
...
/**
 * It calls
 * msg_interface__srv__SetLed_Request__fini()
 ...
 * msg_interface__srv__SetLed_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * msg_interface__srv__SetLed_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msg_interface__srv__SetLed_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_interface
...
/**
 * It calls
 * msg_interface__srv__SetLed_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_interface
...
/**
 * It allocates the memory for the array and calls
 * msg_interface__srv__SetLed_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_interface
...
/**
 * It calls
 * msg_interface__srv__SetLed_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MSG_INTERFACE__SRV__DETAIL__SET_LED__FUNCTIONS_H_
